...
const NewsComp: React.FC<NewsCompProps> = ({ title }) => {
  return (
      ...
      <div className="ml-[5%] w-[90%] h-[15vh]">
        <div className="h-[6vh] mt-[0.5vh] overflow-hidden">
          <p className="line-clamp-2 font-opensans text-sm text-center opacity-70 hover:opacity-100 text-textColor">
            Bilim insanları, yapay zekayla fare beyninin &quot;Dijital
            ikizi&quot; oluşturdu. Model, nöron tepkilerini tahmin ederek
            deneyleri hızlandırıyor. Hedef, insan beyninin sanal kopyasını
            oluşturmak.
          </p>
        </div>

        <div className="h-[5vh] mt-[0.5vh] flex justify-center items-center">
          <button className="group bg-homeContBg flex font-opensans justify-around opacity-70 items-center hover:opacity-100 h-full w-[70%] text-textColor px-[1vw] py-[0.5vh] rounded-lg transition-all duration-300">
            Devamı
